...
func WaitForNodeDrainTimeoutInMachinesToBeUpdated(ctx context.Context, input WaitForNodeDrainTimeoutInMachinesToBeUpdatedInput, intervals ...interface{}) {
	...
	//TODO: delete below
	log.Logf("Make sure the md is updated %s", input.MachineDeployment.Spec.Template.Spec.NodeDrainTimeout)
	...
	Eventually(func() (int, error) {
		...
		//TODO: delete
		log.Logf("len of machines: %s", len(machines))
		log.Logf("value of machines spec nodedraintimeout: %s", machines[0].Spec.NodeDrainTimeout)
